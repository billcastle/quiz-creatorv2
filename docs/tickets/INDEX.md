...
| ID | Title | Area | Status | Branch | PR |
|---|---|---|---|---|---|
| TICKET-001 | Initialize monorepo root & npm workspaces | repo | DONE (2026-07-02) | ticket/001-monorepo-workspaces | [#1](https://github.com/billcastle/quiz-creatorv2/pull/1) |
| TICKET-002 | Shared tooling: strict TS base config + Biome + real root scripts | repo | DONE (2026-07-02) | ticket/002-shared-tooling-tsconfig-biome | [#2](https://github.com/billcastle/quiz-creatorv2/pull/2) |
...
| TICKET-008 | Data layer: Drizzle schema, first migration & category/subcategory seed | backend | DONE (2026-07-03) | ticket/008-data-layer-drizzle-schema-migration-seed | — |
